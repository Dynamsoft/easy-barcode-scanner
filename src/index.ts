...
class EasyBarcodeScanner{
  ...
  static async createInstance(ui: string | HTMLElement = 'https://cdn.jsdelivr.net/gh/Dynamsoft/easy-barcode-scanner@11.0.3003/mobile-native.ui.xml'){
  ...
  static async scan(ui: string | HTMLElement = 'https://cdn.jsdelivr.net/gh/Dynamsoft/easy-barcode-scanner@11.0.3003/easy-barcode-scanner.ui.xml'){
